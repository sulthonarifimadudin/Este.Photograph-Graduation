...
export default function Home() {
  return (
    <>
      ...
      {/* Main Content */}
      <main className="flex-grow pt-12 md:pt-16 pb-40">
        {/* Hero Section: Editorial Collage */}
        <section className="relative w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-md md:py-stack-lg min-h-[70vh] flex flex-col md:flex-row items-center justify-center gap-gutter overflow-hidden">
          ...
          <div className="z-10 w-full flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24 relative">
            {/* Left Title/Typography Area */}
            <div className="w-full md:w-5/12 flex flex-col items-center md:items-start text-center md:text-left space-y-6">
              <h1 className="flex flex-col relative z-20 items-start text-left mb-2 md:mb-0">
                <div 
                  className="relative z-10 font-display-lg text-[40px] sm:text-[50px] md:text-[65px] lg:text-[75px] tracking-tight leading-none"
                  style={{ 
                    color: "black", 
                ...
                <div 
                  className="relative font-editorial-accent text-[55px] sm:text-[65px] md:text-[85px] lg:text-[100px] whitespace-nowrap z-20 -mt-6 sm:-mt-8 md:-mt-12 lg:-mt-16 ml-4 sm:ml-6 md:ml-10 lg:ml-14 transform -rotate-3"
                  style={{ 
            ...
            {/* Right Collage Area */}
            <div className="w-full md:w-7/12 relative h-[400px] md:h-[520px] flex justify-center items-center perspective-[1000px]">
              {/* Central Large Image */}
        ...
        <motion.section 
          ...
          className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg relative" 
          id="packages"
        >
